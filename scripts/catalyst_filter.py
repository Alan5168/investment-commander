...
STOCK_CATALYST_MAP = {
    # === 持仓 ===
    '688190': ['新材料', '软磁材料', '纳米晶'],
    '603556': ['电力设备', '海外出海', '智能电网'],
    '688677': ['医疗器械', '内窥镜', '进口替代'],
    '301268': ['汽车零部件', '新能源车轻量化', '精密结构件'],
    '000818': ['化工', '芯片', 'GPU', '算力'],
    '688116': ['新材料', '碳纳米管', '新能源导电剂'],
    '603505': ['矿产资源', '萤石', '氟化工'],
    '688262': ['半导体', '国产CPU', '嵌入式芯片'],
    '300567': ['半导体设备', '检测', '面板检测'],
    '600745': ['半导体', '手机ODM', '安世半导体'],
    '688332': ['芯片', 'AI芯片', '消费电子', '物联网芯片'],
    '301269': ['半导体', 'EDA软件', '国产替代', '芯片设计'],
    # === 关注股 ===
